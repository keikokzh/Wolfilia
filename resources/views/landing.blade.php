        ...
        <div style="max-width: 1400px; margin: 0 auto; padding: 128px 24px 64px;">
            <div style="max-width: 800px; margin-bottom: var(--spacing-huge);">
                ...
                <div style="display: flex; gap: 16px;">
                    <a href="{{ route('register') }}" class="button-primary-pill">
                        Daftar Sekarang
                    </a>
                    <a href="https://wa.me/6282218410603?text=Halo%20Wolfilium,%20saya%20tertarik%20untuk%20bekerja%20sama." class="button-outline-on-dark" target="_blank" rel="noopener">
                        Jadi Mitra Pembudidaya
                    </a>
                </div>
            </div>
