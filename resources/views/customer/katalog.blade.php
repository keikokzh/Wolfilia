...
<div style="padding: 24px; max-width: 1400px; margin: 0 auto;">
    ...
    {{-- IKAN LELE (Catfish)                     --}}
    {{-- ═══════════════════════════════════════ --}}
    <div class="card animate-slide-up stagger-1" style="margin-bottom: 32px; overflow: hidden;">
        {{-- Header --}}
        <div style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 32px; position: relative; overflow: hidden;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
                <div style="width: 72px; height: 72px; border-radius: 20px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 2px solid rgba(59,130,246,0.3); background: rgba(59,130,246,0.1);">
                    <img src="{{ asset('ikanlele_transparent.png') }}" alt="Ikan Lele" style="width: 90%; height: 90%; object-fit: contain;">
                </div>
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; margin-bottom: 8px;">
                        <h2 style="font-size: 1.5rem; font-weight: 800; color: white; letter-spacing: -0.02em;">Ikan Lele</h2>
                        <span class="badge badge-blue" style="font-size: 11px;">Tersedia</span>
                        <span class="badge badge-green" style="font-size: 11px;">Best Seller</span>
                    </div>
                    <p style="font-size: 0.85rem; color: #94a3b8; font-style: italic;">Clarias gariepinus (African Catfish)</p>
                </div>
                <a href="https://wa.me/6282218410603?text=Halo%20Wolfilium,%20saya%20tertarik%20untuk%20membeli%20ikan%20lele%20dari%20peternakan%20Wolfilium.%20Bisa%20info%20ketersediaan,%20ukuran,%20dan%20harga%20ikan%20lele%20nya?" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; border-radius: 12px; background: #25D366; color: white; text-decoration: none; font-weight: 700; font-size: 0.85rem; font-family: inherit; transition: all 0.2s; flex-shrink: 0;" onmouseover="this.style.background='#128C7E'; this.style.transform='translateY(-2px)'" onmouseout="this.style.background='#25D366'; this.style.transform='translateY(0)'">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 32px;">
                <div style="background: linear-gradient(135deg, #eff6ff, #dbeafe); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(59,130,246,0.2);">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #1e3a5f;">
                        <p>🌡️ <strong>Suhu Air:</strong> 25 – 30°C (optimal 28°C)</p>
                        <p>💧 <strong>pH Air:</strong> 6.5 – 8.0</p>
                        <p>🫧 <strong>Oksigen Terlarut:</strong> > 3 mg/L</p>
                        <p>📏 <strong>Kedalaman Kolam:</strong> 80 – 120 cm</p>
                        <p>🏊 <strong>Tipe Kolam:</strong> Terpal, beton, atau tanah</p>
                        <p>🌙 <strong>Aktivitas:</strong> Nokturnal (aktif malam hari)</p>
                    </div>
                </div>
                ...
                <div style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(16,185,129,0.2);">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #14532d;">
                        <p>🥚 <strong>Masa Pembenihan:</strong> 7 – 14 hari</p>
                        <p>🐟 <strong>Masa Pendederan:</strong> 21 – 30 hari</p>
                        <p>📈 <strong>Masa Pembesaran:</strong> 60 – 90 hari</p>
                        <p>⚖️ <strong>Berat Panen:</strong> 150 – 300 g/ekor</p>
                        <p>🍽️ <strong>FCR:</strong> 1.0 – 1.2 (sangat efisien)</p>
                        <p>📦 <strong>Padat Tebar:</strong> 200 – 400 ekor/m³</p>
                    </div>
                </div>
                ...
                <div style="background: linear-gradient(135deg, #fefce8, #fef9c3); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(245,158,11,0.2);">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #78350f;">
                        <p>🌿 <strong>Pakan Wolffia:</strong> Tinggi protein 40%</p>
                        <p>🚫 <strong>Tanpa Antibiotik:</strong> 100% bebas kimia</p>
                        <p>💪 <strong>Daging Padat:</strong> Tekstur lebih kenyal</p>
                        <p>🐛 <strong>Tanpa Bau Lumpur:</strong> Air kolam terkontrol</p>
                        <p>📋 <strong>Traceability:</strong> Tercatat digital di Wolfilium</p>
                        <p>✅ <strong>Higienis:</strong> Standar sanitasi tinggi</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: var(--surface-elevated); border-radius: var(--rounded-md); padding: 24px; border: 1px solid var(--hairline-light);">
                ...
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                        ...
                        <tbody>
                            @foreach([
                                ['Sortir Kecil', '5 – 8 cm', '± 80 ekor', 'Bibit pembesaran', 'Rp 25.000'],
                                ['Konsumsi Kecil', '15 – 20 cm (± 100g)', '8 – 10 ekor', 'Pecel lele, goreng tepung', 'Rp 28.000'],
                                ['Konsumsi Sedang', '20 – 30 cm (± 200g)', '4 – 5 ekor', 'Lele goreng, bakar', 'Rp 30.000'],
                                ['Konsumsi Besar', '30 – 40 cm (± 300g)', '3 – 4 ekor', 'Lele bakar premium', 'Rp 35.000'],
                            ] as $i => $row)
                            <tr style="border-bottom: 1px solid var(--hairline-light); transition: background 0.2s; {{ $i % 2 === 0 ? '' : 'background: var(--surface-elevated);' }}" onmouseover="this.style.background='rgba(59,130,246,0.05)'" onmouseout="this.style.background='{{ $i % 2 === 0 ? '' : 'var(--surface-elevated)' }}'">
                                <td style="padding: 14px 16px; font-weight: 600; color: var(--ink);">{{ $row[0] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[1] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[2] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[3] }}</td>
                                <td style="padding: 14px 16px; text-align: right; font-weight: 700; color: #059669;">{{ $row[4] }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                </div>
                <p style="margin-top: 12px; font-size: 0.75rem; color: var(--shade-60); font-style: italic;">* Harga dapat berubah sewaktu-waktu. Hubungi kami via WhatsApp untuk harga terbaru dan pemesanan.</p>
            </div>
        </div>
    </div>
    ...
    {{-- IKAN NILA (Tilapia)                     --}}
    {{-- ═══════════════════════════════════════ --}}
    <div class="card animate-slide-up stagger-2" style="margin-bottom: 32px; overflow: hidden;">
        {{-- Header --}}
        <div style="background: linear-gradient(135deg, #064e3b 0%, #022c22 100%); padding: 32px; position: relative; overflow: hidden;">
            <div style="position: absolute; top: -30px; right: -30px; width: 200px; height: 200px; border-radius: 50%; background: radial-gradient(circle, rgba(16,185,129,0.15), transparent); pointer-events: none;"></div>
            <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
                <div style="width: 72px; height: 72px; border-radius: 20px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 2px solid rgba(16,185,129,0.3); background: rgba(16,185,129,0.1);">
                    <img src="{{ asset('ikannilav2_transparent.png') }}" alt="Ikan Nila" style="width: 90%; height: 90%; object-fit: contain;">
                </div>
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; margin-bottom: 8px;">
                        <h2 style="font-size: 1.5rem; font-weight: 800; color: white; letter-spacing: -0.02em;">Ikan Nila</h2>
                        <span class="badge badge-green" style="font-size: 11px;">Tersedia</span>
                        <span style="display: inline-block; padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 700; background: rgba(245,158,11,0.2); color: #fbbf24; border: 1px solid rgba(245,158,11,0.3);">Populer</span>
                    </div>
                    <p style="font-size: 0.85rem; color: #94a3b8; font-style: italic;">Oreochromis niloticus (Nile Tilapia)</p>
                </div>
                <a href="https://wa.me/6282218410603?text=Halo%20Wolfilium,%20saya%20tertarik%20untuk%20membeli%20ikan%20nila%20dari%20peternakan%20Wolfilium.%20Bisa%20info%20ketersediaan,%20ukuran,%20dan%20harga%20ikan%20nila%20nya?" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; border-radius: 12px; background: #25D366; color: white; text-decoration: none; font-weight: 700; font-size: 0.85rem; font-family: inherit; transition: all 0.2s; flex-shrink: 0;" onmouseover="this.style.background='#128C7E'; this.style.transform='translateY(-2px)'" onmouseout="this.style.background='#25D366'; this.style.transform='translateY(0)'">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                    Beli Ikan Nila
                </a>
            </div>
        ...
        <div style="padding: 32px;">
            ...
            <div style="margin-bottom: 32px;">
                ...
                <p style="color: var(--shade-60); line-height: 1.7; font-size: 0.9rem;">
                    Ikan Nila (<em>Oreochromis niloticus</em>) merupakan salah satu ikan air tawar paling populer di Indonesia. Nila dari peternakan Wolfilium dibudidayakan secara semi-intensif dengan suplemen pakan Wolffia yang kaya protein dan mineral. Dagingnya putih bersih, tebal, dengan rasa yang lembut dan sedikit manis — sangat cocok untuk nila bakar, nila goreng, fillet, maupun olahan modern. Ikan ini juga kaya akan asam amino esensial dan rendah lemak jenuh.
                </p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 32px;">
                <div style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(16,185,129,0.2);">
                    <h4 style="font-size: 0.85rem; font-weight: 700; color: #166534; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#166534" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                        Habitat & Lingkungan
                    </h4>
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #14532d;">
                        <p>🌡️ <strong>Suhu Air:</strong> 25 – 30°C (optimal 27°C)</p>
                        <p>💧 <strong>pH Air:</strong> 6.5 – 8.5</p>
                        <p>🫧 <strong>Oksigen Terlarut:</strong> > 4 mg/L</p>
                        <p>📏 <strong>Kedalaman Kolam:</strong> 100 – 150 cm</p>
                        <p>🏊 <strong>Tipe Kolam:</strong> Tanah, beton, jaring apung</p>
                        <p>☀️ <strong>Aktivitas:</strong> Diurnal (aktif siang hari)</p>
                    </div>
                </div>

                <div style="background: linear-gradient(135deg, #eff6ff, #dbeafe); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(59,130,246,0.2);">
                    <h4 style="font-size: 0.85rem; font-weight: 700; color: #1e40af; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1e40af" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>
                        Siklus Budidaya
                    </h4>
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #1e3a5f;">
                        <p>🥚 <strong>Masa Pembenihan:</strong> 5 – 7 hari</p>
                        <p>🐟 <strong>Masa Pendederan:</strong> 30 – 45 hari</p>
                        <p>📈 <strong>Masa Pembesaran:</strong> 120 – 180 hari</p>
                        <p>⚖️ <strong>Berat Panen:</strong> 200 – 500 g/ekor</p>
                        <p>🍽️ <strong>FCR:</strong> 1.4 – 1.7</p>
                        <p>📦 <strong>Padat Tebar:</strong> 15 – 30 ekor/m²</p>
                    </div>
                </div>

                <div style="background: linear-gradient(135deg, #fdf4ff, #fae8ff); border-radius: var(--rounded-md); padding: 24px; border: 1px solid rgba(168,85,247,0.2);">
                    <h4 style="font-size: 0.85rem; font-weight: 700; color: #6b21a8; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6b21a8" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                        Keunggulan Wolfilium
                    </h4>
                    <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.8rem; color: #581c87;">
                        <p>🌿 <strong>Suplemen Wolffia:</strong> Protein & mineral alami</p>
                        <p>🐄 <strong>Daging Putih Bersih:</strong> Tebal, lembut, manis</p>
                        <p>🔬 <strong>Seleksi Genetik:</strong> Strain GIFT unggul</p>
                        <p>💊 <strong>Rendah Lemak:</strong> Hanya 1.7 – 3 g/100g</p>
                        <p>🌍 <strong>Ramah Lingkungan:</strong> Budidaya berkelanjutan</p>
                        <p>🏷️ <strong>Sertifikasi:</strong> Standar CBIB nasional</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: var(--surface-elevated); border-radius: var(--rounded-md); padding: 24px; border: 1px solid var(--hairline-light);">
                <h4 style="font-size: 0.85rem; font-weight: 700; color: var(--ink); margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
                    Ukuran Tersedia & Estimasi Harga
                </h4>
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                        ...
                        <tbody>
                            @foreach([
                                ['Bibit / Nener', '3 – 5 cm', '± 200 ekor', 'Bibit pembesaran', 'Rp 300/ekor'],
                                ['Konsumsi Kecil', '15 – 20 cm (± 200g)', '4 – 5 ekor', 'Nila goreng rumahan', 'Rp 32.000'],
                                ['Konsumsi Sedang', '20 – 28 cm (± 350g)', '2 – 3 ekor', 'Nila bakar, pepes', 'Rp 35.000'],
                                ['Konsumsi Besar', '28 – 35 cm (± 500g)', '2 ekor', 'Restoran, fillet premium', 'Rp 40.000'],
                            ] as $i => $row)
                            <tr style="border-bottom: 1px solid var(--hairline-light); transition: background 0.2s; {{ $i % 2 === 0 ? '' : 'background: var(--surface-elevated);' }}" onmouseover="this.style.background='rgba(16,185,129,0.05)'" onmouseout="this.style.background='{{ $i % 2 === 0 ? '' : 'var(--surface-elevated)' }}'">
                                <td style="padding: 14px 16px; font-weight: 600; color: var(--ink);">{{ $row[0] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[1] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[2] }}</td>
                                <td style="padding: 14px 16px; text-align: center; color: var(--shade-60);">{{ $row[3] }}</td>
